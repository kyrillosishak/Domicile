...
import type { InjectedConfig, StorageConfig, EmbeddingConfig, PerformanceConfig } from './types';

export interface CreateDomicileOptions {
  storage: StorageConfig;
  dimensions: number;
  metric?: 'cosine' | 'euclidean' | 'dot';
  embedding: Omit<EmbeddingConfig, 'device'> & { device?: 'wasm' | 'webgpu' };
...
export async function createDomicile(options: CreateDomicileOptions): Promise<VectorDB> {
