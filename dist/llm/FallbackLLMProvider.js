...
export class FallbackLLMProvider {
    ...
    async initialize() {
        ...
        throw new Error('FallbackLLMProvider: no provider is available in this environment ' +
     ...
     */
    async nextAvailable(afterIndex) {
...
//# sourceMappingURL=FallbackLLMProvider.js.map